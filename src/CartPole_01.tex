...
\title{CartPole Q-Learning Implementation}
%\author{Author Name}
%\date{\today}
...
\]
which can also be written as $a_t \in \{-1, +1\}$ when using a signed force convention. At each time step, the agent applies a force $F_t$ to the cart, and the environment 
evolves according to the following nonlinear dynamics of the cart-pole system: 
\begin{align*}
